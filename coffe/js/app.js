(() => {
    ...
    const tabsBtn = document.querySelectorAll(".tabs-giftset__btn");
    const tabsItems = document.querySelectorAll(".body-tabs-giftset__column");
    ...
    function onTabClick(i) {
        i.addEventListener("click", (() => {
            ...
            if (!currentBtn.classList.contains("tabs-giftset__btn-active")) {
                tabsBtn.forEach((function(i) {
                    i.classList.remove("tabs-giftset__btn-active");
                }));
                tabsItems.forEach((function(i) {
                    i.classList.remove("body-tabs-giftset__column-active");
                }));
                currentBtn.classList.add("tabs-giftset__btn-active");
                currentTab.classList.add("body-tabs-giftset__column-active");
            }
        }));
    }
    window["FLS"] = true;
